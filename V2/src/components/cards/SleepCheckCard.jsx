        ...
        <div className="glass-card-prominent p-8 max-w-md mx-auto">
            ...
            <div className="space-y-6">
              ...
              `}
                ...
                ${selected === index ? 'text-white font-semibold' : 'text-gray-300'}
              `}
                        >
                            {label}
                        </div>
            ...
            <div className="mt-8">
                <VoiceInput onInput={(text) => {
                    ...
                    // For now, we'll just log it. In a real app, we'd send this to the AI to infer the rating.
                    // If the text contains keywords, we could auto-select.
