            ...
            if (needsImage) {
                ...
                const result = await model.generateContent({
                    ...
                    systemInstruction: {
                        role: 'system',
                        parts: [{
                            text: "You are 'Coach Saty', an expert fitness and nutrition coach. You are energetic, motivating, and highly knowledgeable. Provide detailed, helpful responses with practical advice. Use emojis sparingly but effectively."
                        }]
                    }
                });
