...
export class ProgressiveOverload {
    ...
    calculateProgression(exerciseHistory, lastPerformance) {
        ...
        if (plateauDetected) {
            console.log(`⚠️ Plateau detected for ${exerciseName} - switching training style`);
    ...
    recordPerformance(exerciseName, performance) {
        ...
        console.log(`📊 Recorded: ${exerciseName} - ${performance.weight}kg x ${performance.reps} reps (RPE: ${performance.rpe})`);
