...
export default function Onboarding() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-violet-600 via-fuchsia-500 to-indigo-600" style={{ backgroundSize: '200% 200%', animation: 'gradientShift 15s ease infinite' }}>
            {/* Content */}
