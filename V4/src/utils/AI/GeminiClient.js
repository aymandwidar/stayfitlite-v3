  ...
  "tips": 2-3 quick tips (array of strings)
    ...
    async generateStructuredInsight({ systemInstruction, userQuery, schema }) {
        try {
            ...
            console.error("Gemini Structured Insight Error:", error);
            throw error;
        }
    }
};
